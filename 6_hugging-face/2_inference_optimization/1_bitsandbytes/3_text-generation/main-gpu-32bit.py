...
# model 5GB = 1x5GB = does not work (not enough resources ??)
# model_id = "mosaicml/mpt-1b-redpajama-200b"
# tokenizer = AutoTokenizer.from_pretrained(model_id)
# model = AutoModelForCausalLM.from_pretrained(
#     model_id, trust_remote_code=True, attn_impl="triton"
# )
...
# model 7GB = 1x7GB = error
# model_id = "gpt2-xl"
# tokenizer = AutoTokenizer.from_pretrained(model_id)
# model = AutoModelForCausalLM.from_pretrained(model_id)

# model 9GB = 4x2GB + 1x1GB = WORKS
# (probably via the fact that the model is on base 8bit)
