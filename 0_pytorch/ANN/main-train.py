...
training_data.train_data.to(torch.device("cuda:0"))  # put data into GPU entirely
...
test_data.train_data.to(torch.device("cuda:0"))  # put data into GPU entirely
test_data.train_labels.to(torch.device("cuda:0"))
